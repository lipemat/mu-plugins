...
/**
 * Allows specifying a particular object cache to test against.
 *
 * Both handlers share this suite, so the run is repeated with this
 * pointed at `object-cache/opcache.php`.
 */
if ( \is_string( \getenv( 'OBJECT_CACHE_HANDLER' ) ) && '' !== \getenv( 'OBJECT_CACHE_HANDLER' ) ) {
	define( 'OBJECT_CACHE_HANDLER', \getenv( 'OBJECT_CACHE_HANDLER' ) );
}
...
$config_defaults = [
	...
	'WP_CACHE_DIR'              => WP_SITE_ROOT . 'wp-content/cache',
